...
pub mod core_scheduling_mode;
pub use self::core_scheduling_mode::CoreSchedulingMode;
...
pub mod generic_vhost_user_config;
pub use self::generic_vhost_user_config::GenericVhostUserConfig;
pub mod image_type;
...
pub use self::lock_granularity::LockGranularity;
pub mod memory_config;
pub use self::memory_config::MemoryConfig;
pub mod memory_restore_mode;
pub use self::memory_restore_mode::MemoryRestoreMode;
...
pub mod vm_resize_disk;
pub use self::vm_resize_disk::VmResizeDisk;
